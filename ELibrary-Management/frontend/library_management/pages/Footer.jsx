        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <p className="footer-description">
              GLS Library is your gateway to a world of knowledge. With an extensive collection of books and resources, we strive to promote learning and literacy for all.
            </p>
          </div>
            ...
            <ul className="list-unstyled">
              <li>
                <a href="https://maps.app.goo.gl/J5wsVDZtC5qm4Use6" target="_blank" rel="noopener noreferrer">
                  <i className="fas fa-map-marker-alt"></i> Netaji Rd, Opp. Law Garden, Ellisbridge, Ahmedabad, Gujarat - 380006
                </a>
              </li>
              <li>
                <i className="fas fa-phone" style={{ transform: "rotate(90deg)" }}></i> 079 2644 0532
              </li>
              <li>
                <i className="fas fa-envelope"></i> inquiry@glsuniversity.ac.in
              </li>
            </ul>
          </div>
