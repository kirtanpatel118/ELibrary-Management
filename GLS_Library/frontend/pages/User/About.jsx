...
function About() {
  ...
  return (
    <>  
        ...
        <section className="library-features py-5 bg-light">
                <div className="container">
                        <h2 className="text-center mb-5">What Makes Us Special</h2>
                        <div className="row">
                                {/* <!-- Feature 1 --> */}
                                <div className="col-md-4 mb-4 text-center">
                                        <i className="fas fa-book-reader fa-3x text-primary mb-3"></i>
                                        <h4 className="mb-3">Extensive Collection</h4>
                                ...
                                {/* <!-- Feature 3 --> */}
                                <div className="col-md-4 mb-4 text-center">
                                        <i className="fas fa-user-friends fa-3x text-primary mb-3"></i>
                                        <h4 className="mb-3">Community Events</h4>
